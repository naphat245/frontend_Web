                        ...
                        <div class="Box">
                            <div class="LoginBox">
                                <q-form @submit.prevent="onSubmit" class="q-gutter-md" ref="myLoginForm">
                                    <h1>Admin Login</h1>
                                    <div class="input-box">
                                        <q-input color="primary" rounded outlined v-model="username" label="Username"
                                            type="text" />
                                    </div>
                                    <div class="input-box">
                                        <q-input color="primary" rounded outlined v-model="password" label="Password"
                                            type="password" />
                                    </div>
                                    ...
                                    <div class="register-link">
                                        <p class="text-black">You are not Admin? <a @click="gotoLogin">Go to user login</a>
                                        </p>
                                    </div>
                                </q-form>
                            </div>
